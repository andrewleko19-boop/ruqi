...
const LIST_TYPE_LABELS = {
  ...
  // «المنطقة التعليمية» و«المجمّع التربوي» في التقسيم الإداريّ السوريّ الشيءُ
  // نفسه — مدينة اللاذقية، جبلة، الحفة، القرداحة. وكانت قائمتين، فملأ المشرفُ
  // واحدةً ونسي الأخرى: خمسُ مناطق ومجمّعٌ واحد، ثمّ يكتب كلُّ مديرٍ اسم مجمّعه
  // على وجهٍ فيتفتّت التجميع في لوحتَي المديرية والوزارة. صارتا واحدة، وبوّابة
  // المدرسة تقرأ منها في الموضعين. و school_complex لم تعد تُقرأ من أيّ مكان،
  // فرفعناها من هنا كي لا يملأ المشرفُ قائمةً لا قارئ لها.
  educational_zone:   'المناطق التعليمية / المجمّعات التربوية (لكل مديرية)',
...
const PER_DIRECTORATE_LISTS = new Set(['educational_zone']);
