...
function showScreen(name) {
  ...
  /* التنبيهات تعيش خارج الشاشتين فتنجو من التبديل بينهما. لو سقطت الجلسة بعد
     إطلاق تنبيه — انتهاء صلاحية، خروج، فشل تحقّق — بقي معلّقاً فوق شاشة الدخول
     يفشي حالةَ صفٍّ لمن لم يسجّل دخوله. شاشة الدخول تبدأ نظيفةً دائماً. */
  if (name === 'login') {
